    ...
    <section style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Contact Us Button - ALWAYS IN ROW on mobile (not stacked) */}
          <div style={{
            display: "flex",
            gap: "20px",
            flexDirection: "row", // Always row, never column
            alignItems: "center",
            flexWrap: isSmallScreen ? "wrap" : "nowrap", // Wrap if needed but keep row
            marginBottom: "20px"
          }}>
            <a
              href="/contact"
        ...
        {/* RIGHT SIDE - Tech Illustration with Icons - ONLY SHOW ON DESKTOP */}
        {!isMobile && (
          <div style={{
            flex: "1",
            display: "flex",
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#016712" strokeWidth="2">
